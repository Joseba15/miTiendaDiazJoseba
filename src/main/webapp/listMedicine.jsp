	...
	<div>
		<a href="carrito.jsp">
				<button id="singlebutton" name="singlebutton"
					...
					<%=carrito.getListaCarrito().size() %>
				</button>						
		</a>
	</div>
	<div>
		<a href="historialCompra.jsp">
				<button id="singlebutton" name="singlebutton" class="btn btn-dark" >
				 Purchase History
				</button>						
		</a>
	</div>
				...
				<tr>
					...
					<td>
						<form action='addToCarrito.jsp' method='post' >
		                        ...
		                        <%} %>
		                        <%if(me.getStock()==0) {%>
									<input type='number' min='0' max="0" value="0" name='amount'>
								<%} %>
